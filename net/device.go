...
func FindIfceByName(name string) (net.Interface, error) {
	ifces, err := net.Interfaces()
	if err != nil {
	...
	return net.Interface{}, fmt.Errorf("Not Found")
}

func FindIfceByIndex(ifIndex int) (net.Interface, error) {
	ifces, err := net.Interfaces()
	if err != nil {
		return net.Interface{}, err
	}
	for _, ifce := range ifces {
		if ifce.Index == ifIndex {
			return ifce, nil
		}
	}
	return net.Interface{}, fmt.Errorf("Not Found")
